...
const fr: Dict = {
  ...
  "book.datesLoading": "Recherche des disponibilités…",
  "book.nextAvailable": "Prochaine disponibilité",
  "book.fullyBooked": "L'agenda est complet pour le moment. Écrivez-nous sur Instagram : on vous prévient dès qu'une place se libère.",
  "book.closed": "Fermé",
...
const en: Dict = {
  ...
  "book.datesLoading": "Checking availability…",
  "book.nextAvailable": "Next opening",
  "book.fullyBooked": "The calendar is full right now. Message us on Instagram and we'll tell you as soon as a spot opens up.",
  "book.closed": "Closed",
  "book.name": "Full name",
  "book.email": "Email",
  "book.phone": "Phone",
